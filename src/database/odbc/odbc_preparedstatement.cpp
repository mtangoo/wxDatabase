...
wxOdbcPreparedStatement::wxOdbcPreparedStatement(wxOdbcInterface* pInterface, SQLHENV sqlEnvHandle, SQLHDBC sqlHDBC, wxOdbcStatementVector statements)
 : wxPreparedStatement()
{
    m_pInterface = pInterface;
    m_sqlEnvHandle = sqlEnvHandle;
...
void wxOdbcPreparedStatement::InterpretErrorCodes( long WXUNUSED(nCode), SQLHSTMT stmth_ptr )
{
