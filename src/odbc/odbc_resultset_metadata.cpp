...
// ctor
wxOdbcResultSetMetaData::wxOdbcResultSetMetaData(wxOdbcInterface* pInterface, SQLHSTMT sqlOdbcStatement)
{
  m_pInterface = pInterface;
  m_pOdbcStatement = sqlOdbcStatement;
}

int wxOdbcResultSetMetaData::GetColumnType(int i)
{
...
int wxOdbcResultSetMetaData::GetColumnSize(int i)
{
  int returnSize = -1;
...
wxString wxOdbcResultSetMetaData::GetColumnName(int i)
{
  wxString columnName;
...
int wxOdbcResultSetMetaData::GetColumnCount()
{
