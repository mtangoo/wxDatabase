#ifndef __wxDATABASE_LAYER_H__
#define __wxDATABASE_LAYER_H__
...
class WXDLLIMPEXP_DATABASELAYER wxDatabase : public wxDatabaseErrorReporter, public wxDatabaseStringConverter
{
public:
  /// Constructor
  wxDatabase();
