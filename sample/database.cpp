...
// Author:      Stefano Mtangoo <stefano@hosannahighertech.co.tz>
// Modified by: Adapted from wxWidgets Console application for wxDatabase uses 
...
//todo: put conn parameters h-host u-user p-password
...
bool RunCreate(wxDatabase* db)
{

}

bool RunInsert(wxDatabase* db)
{

}

bool RunUpdate(wxDatabase* db)
{

}

bool RunSelect(wxDatabase* db)
{

}

bool RunDelete(wxDatabase* db)
{

}

bool RunConnect(const wxString& host, const wxString& user, const wxString& pass, wxDatabase* handle)
{
